  ...
  return (
    <div className="exploreprop">
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
        ...
        <Card className="card expcard" style={{ flex: '1 0 30%', margin: '10px' }} onClick={() => navigateToProperties('rental')}>
        ...
        <Card className="card expcard" style={{ flex: '1 0 30%', margin: '10px' }} onClick={() => navigateToProperties('Flat')}>
          <Card.Img variant="top" src='/Assets/Images/flat1.jpg' className="cimg" />
          <Card.Body>
        ...
        <Card className="card expcard" style={{ flex: '1 0 30%', margin: '10px' }} onClick={() => navigateToProperties('House')}>
          <Card.Img variant="top" src='/Assets/Images/house1.jpg' className="cimg" />
          <Card.Body>
